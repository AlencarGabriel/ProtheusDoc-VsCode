...
export class WhatsNewManager {
    ...
    public showPageInActivation() {
        ...
        let extension = vscode.extensions.getExtension(`alencargabriel.${this.extensionName}`);
        ...
        if (extension) {
            ...
            this.showPageIfVersionDiffers(this.extension.packageJSON.version, previousExtensionVersion ? previousExtensionVersion : "");
        }
    }
