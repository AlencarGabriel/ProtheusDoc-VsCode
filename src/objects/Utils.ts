...
export class Utils {
	 ...
	 */
	public getUseSuggestCustom(): boolean {
		let useUseSuggestCustom = this.getConfig().get<boolean>("usa_sugestao_customizada");

		if (useUseSuggestCustom !== undefined) {
			return useUseSuggestCustom;
		} else {
			return true;
		}
	}
